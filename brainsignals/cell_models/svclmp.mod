TITLE svclmp.mod
COMMENT
MODIFIED BY TORBJORN NESS 24.02.2020 TO BE IONIC CURRENT INSTEAD OF ELECTRODE_CURRENT
THIS WAS DONE TO HAVE CURRENT BALANCE ACROSS MEMBRANE
